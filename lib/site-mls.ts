...
export const MLS_NAV = [
  ...
  },
  {
    ...
    label: 'Ventures',
    children: [
      { href: '/verticals/stone-export', label: 'Stone & Export', external: 'https://khadane.com' },
  ...
  },
  {
    ...
    external: true,
    children: [
      { href: 'https://khadane.com', label: 'KHADANE™ Site', external: true },
      { href: 'https://khadane.com/collection', label: 'Varieties', external: true },
      { href: 'https://khadane.com/formats', label: 'Formats', external: true },
    ],
  },
  {
    href: '/resources',
...
// Vertical hero video (locked from briefing)
export const MLS_HERO_VIDEO =
