  ...
  return (
    <header
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ease-editorial ${
        scrolled
          ? 'bg-mls-cream/95 backdrop-blur-md border-b border-mls-ink/8'
          : 'bg-mls-cream/80 backdrop-blur-sm'
      }`}
    >
      <div className="mx-auto px-6 md:px-12 lg:px-16 max-w-[88rem]">
        ...
        >
                ...
                return (
                  ...
                  >
                    <button
                      ...
                      className={`px-4 py-2 text-sm font-body tracking-wide text-mls-ink/80 hover:text-mls-gold transition-colors duration-300 ${
              ...
              if (isExternal) {
                return (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="px-4 py-2 text-sm font-body tracking-wide text-mls-ink/80 hover:text-mls-gold transition-colors duration-300 inline-flex items-center gap-1"
                  >
                    {item.label}
          ...
          <button
            ...
            className="lg:hidden p-2 -mr-2 text-mls-ink"
            aria-expanded={mobileOpen}
            aria-label="Toggle menu"
          >
            <div className="w-6 h-5 flex flex-col justify-between">
              <span
                className={`block h-px bg-mls-ink transition-all duration-300 ${
                  mobileOpen ? 'rotate-45 translate-y-2' : ''
                }`}
              />
              <span
                className={`block h-px bg-mls-ink transition-opacity duration-300 ${
