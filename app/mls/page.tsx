  ...
  return (
    <>
      {/* ============================================================
          SECTION 01 — HERO
          ============================================================ */}
      <section className="relative bg-mls-cream overflow-hidden">
        <div className="mx-auto px-6 md:px-12 lg:px-16 max-w-[88rem] pt-16 lg:pt-28 pb-20 lg:pb-32">
          <div className="max-w-5xl">
            ...
            <RevealOnScroll delay={100}>
              <h1 className="font-display text-5xl md:text-7xl lg:text-[8.5rem] tracking-tighter leading-[1.02] text-mls-ink mb-8">
                A working group.
            ...
            <RevealOnScroll delay={250}>
              <p className="font-display italic text-2xl md:text-3xl text-mls-tobacco max-w-2xl leading-snug mb-12">
            ...
            <RevealOnScroll delay={400}>
              <div className="flex flex-wrap gap-4">
                <Link
                  href="/our-legacy"
                  className="inline-flex items-center gap-3 px-8 py-4 bg-mls-ink text-mls-cream text-sm font-body tracking-wider uppercase hover:bg-mls-tobacco hover:gap-4 transition-all duration-400 ease-editorial"
                >
                  Read the legacy
                ...
                <a
                  ...
                  className="inline-flex items-center gap-3 px-8 py-4 border border-mls-ink text-mls-ink text-sm font-body tracking-wider uppercase hover:bg-mls-ink hover:text-mls-cream hover:gap-4 transition-all duration-400 ease-editorial"
                >
                  Visit KHADANE™
      ...
      <section className="bg-mls-cream py-20 lg:py-32 border-t border-mls-ink/10">
        <div className="mx-auto px-6 md:px-12 lg:px-16 max-w-[88rem]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-mls-ink/10">
            {VERTICALS.map((v, idx) => {
              const number = String(idx + 1).padStart(2, '0')
              const isStone = v.slug === 'stone-export'
              return (
                <RevealOnScroll key={v.slug} delay={idx * 80}>
                  <VerticalCard
                    href={isStone ? 'https://khadane.com' : `/verticals/${v.slug}`}
                    external={isStone}
                    number={number}
                    title={v.title}
                    brand={v.brand}
      ...
      {/* ============================================================
          ...
          ============================================================ */}
      <section className="bg-mls-tobacco text-mls-cream py-24 lg:py-40">
        <div className="mx-auto px-6 md:px-12 lg:px-16 max-w-[88rem]">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-5">
              <RevealOnScroll delay={200}>
                <PlaceholderImage
                  label="BIJOLIA · DOCUMENTARY"
                  title="Working stone, working hands."
                  spec="1200 × 1500px · Quarry-face documentary, mid-morning light, hands visible"
                  swapPath="/img/bijolia-quarry-face.jpg"
      ...
      {/* ============================================================
          ...
          ============================================================ */}
      <section className="bg-mls-cream py-24 lg:py-32 border-t border-mls-ink/10">
        <div className="mx-auto px-6 md:px-12 lg:px-16 max-w-[88rem]">
