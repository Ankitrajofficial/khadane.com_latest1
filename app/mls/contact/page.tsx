      ...
      <section className="bg-mls-buff/20 py-20 lg:py-28 border-y border-mls-ink/10">
        <div className="mx-auto px-6 md:px-12 lg:px-16 max-w-[88rem]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-px bg-mls-ink/10">
            <RevealOnScroll>
              <div className="bg-mls-cream p-8 lg:p-10">
            ...
            <RevealOnScroll delay={100}>
              <div className="bg-mls-cream p-8 lg:p-10">
                ...
                <p className="text-sm text-mls-ink/75 mb-1">
                  M3 Boutique Hotel · M3 Mini Mall · The Princess · Victoria
                  Palace · Boys&rsquo; PGs · Vyanjanam
                </p>
                <p className="font-mono text-[10px] uppercase tracking-marker text-mls-slate mt-4">
